...
${main_sign_up_button}  //nav[@id='site-navigation']//a[@href='https://shop.circles.life/signup?reset=true' and text()='Sign up']
${main_buy_now_button}  //nav[@id='site-navigation']//a[@href='https://shop.circles.life/login?reset=true' and text()='Buy now']
...
${signed_in_header_h5}  //h5[@id='exampleModalLabel']
...
${fb_text_comment}  This is my special comment to Circles Life.
