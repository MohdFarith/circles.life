...
Access To Sign In/Create Account Page
  Mouse Over  ${main_buy_now_button}
  Wait Until Element Is Visible  ${main_buy_now_button}
  Click Element  ${main_buy_now_button}
  Wait Until Page Does Not Contain Element  ${main_buy_now_button}  timeout=15
...
Successful Signed In Landing
  ...
  Wait Until Page Contains Element  ${signed_in_header_h5}
  Capture Page Screenshot
